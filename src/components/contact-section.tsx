        ...
        <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
          <div className="night-card rounded-[1.5rem] border p-6">
            ...
            <div className="mt-5 grid gap-3">
              <a className="flex items-center gap-3 rounded-2xl border border-primary/15 bg-background/60 p-4 transition hover:bg-muted" href={`mailto:${profile.email}`}>
                <Mail size={20} />
                {profile.email}
              </a>
              <a className="flex items-center gap-3 rounded-2xl border border-primary/15 bg-background/60 p-4 transition hover:bg-muted" href={profile.linkedin}>
                <Linkedin size={20} />
                LinkedIn
              </a>
