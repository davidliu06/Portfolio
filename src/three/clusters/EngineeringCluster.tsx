...
import { MechanicalPart, type PartKind } from "@/three/components/MechanicalPart";
...
/** Active during curiosity, building, and engineering chapters. */
export function EngineeringCluster() {
  ...
  useFrame(() => {
    ...
    groupRef.current.visible =
      ...
      activeChapter === "building" ||
      activeChapter === "engineering";
  });
    ...
    <group ref={groupRef}>
      ...
      {PARTS.map((part, index) => (
        <MechanicalPart
          key={index}
          {...part}
          onSecretFound={part.secret ? () => addProgress("hidden-gear") : undefined}
        />
      ))}
    </group>
  );
