    ...
    <group position={position}>
      ...
      {!isActive && (
        <Html center distanceFactor={10} position={[0, -1.7, 0]} style={{ pointerEvents: "none" }}>
          <p className="whitespace-nowrap rounded-full border border-white/15 bg-card/95 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-foreground shadow-glow">
            {project.shortTitle}
          </p>
        </Html>
      )}
